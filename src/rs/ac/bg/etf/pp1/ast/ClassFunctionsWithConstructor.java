...
public class ClassFunctionsWithConstructor extends ClassFunctions {

    private ConstructorDeclList ConstructorDeclList;

    public ClassFunctionsWithConstructor (ConstructorDeclList ConstructorDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassFunctionsWithConstructor(\n");
